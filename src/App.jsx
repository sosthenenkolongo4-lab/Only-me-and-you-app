...
function Chat({ data, name, save }) {
  ...
  return (
    <div>
      ...
      <div className="chat card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', paddingBottom: '150px' }}>
      ...
      <div
        style={{
          position: 'fixed', left: '14px', right: '14px', bottom: '96px', zIndex: 900,
      ...
      >
        {editingId && (
          <div style={{
            ...
            padding: '8px 12px', marginBottom: '8px', fontSize: '0.82rem', color: '#C9184A',
        ...
        <div className="composer" style={{ background: '#fff', boxShadow: '0 6px 20px rgba(0,0,0,0.10)' }}>
