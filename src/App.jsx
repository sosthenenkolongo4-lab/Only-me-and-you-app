    ...
    if (this.state.error) {
      return (
        <div style={{
          ...
          <h2 style={{ marginTop: 0 }}>Erreur détectée</h2>
          <pre style={{
            whiteSpace: "pre-wrap",
            fontSize: 14,
          ...
          <p style={{ marginTop: 20, fontSize: 14, opacity: 0.9 }}>
            Copie ce message d’erreur et envoie-le moi pour que je corrige.
          </p>
        </div>
      );
    }
...
Pour il affiche à l'horizontale quand jd colle
