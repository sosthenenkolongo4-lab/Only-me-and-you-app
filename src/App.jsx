    ...
    <div>
      ...
      <style>{`
        ...
        .oamy-day-sep {
          ...
          margin: 14px 4px 10px; color: #b98; font-size: 0.72rem; font-weight: 700;
          letter-spacing: 0.04em; text-transform: uppercase;
        }
        .oamy-day-sep::before, .oamy-day-sep::after {
          content: ""; flex: 1; height: 1px; background: rgba(201,24,74,0.15);
        }
                  ...
                  {m.replyTo && (
                    <div
                      ...
                      style={{
                        ...
                        background: mine ? 'rgba(255,255,255,0.92)' : '#ffffff',
                    ...
                    >
                      ...
                      <span style={{
                        fontSize: '0.76rem', color: '#6b4657', whiteSpace: 'nowrap', overflow: 'hidden',
