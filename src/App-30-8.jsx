                  ...
                  {m.replyTo && (
                    <div
                      ...
                      style={{
                        ...
                        borderLeft: '4px solid #C9184A',
                        background: '#ffffff',
                        border: '1px solid rgba(201,24,74,0.18)',
                        boxShadow: '0 1px 2px rgba(0,0,0,0.10)',
                        borderRadius: '8px', padding: '5px 9px', marginBottom: '6px', cursor: 'pointer'
                      }}
                    >
                      <span style={{ fontSize: '0.72rem', fontWeight: 700, color: '#C9184A' }}>
                        {m.replyTo.author === name ? "Vous" : m.replyTo.author}
                      </span>
                      <span style={{
                        fontSize: '0.76rem', color: '#4a1030', whiteSpace: 'nowrap', overflow: 'hidden',
        ...
        <div className="oamy-chat-composer-wrap">
          ...
          <div
            ...
            style={{
              ...
              padding: '5px 6px 5px 12px', margin: '8px',
              background: '#fff', border: '1px solid #f1dbe4', borderRadius: '22px',
              boxShadow: '0 2px 8px rgba(201,24,74,0.06)'
            }}
          >
            <button
              onClick={() => setShowCard(true)}
              title="Carte vœux"
              style={{ background: 'none', border: 'none', color: '#C9184A', opacity: 0.7, padding: '2px', display: 'flex', alignItems: 'center', cursor: 'pointer', flexShrink: 0 }}
            >
              <Gift size={18} />
            </button>
            <input
